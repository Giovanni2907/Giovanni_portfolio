        ...
        <Section id="about">
          ...
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-6">
              <div className="rounded-xl border-4 border-[#E4B9A5] bg-background/70 px-6 py-5 text-base text-muted-foreground shadow-sm dark:text-gray-100 lg:text-[17px]">
                Je suis un développeur web basé à Madagascar qui continue à perfectionner ses compétences pour devenir un professionnel complet du web.
                <br />
                <br />
