  ...
  fr: {
    ...
    about: {
      ...
      lines: [
        ...
        "J’aime transformer des idées en produits élégants et fiables pour satisfaires mes besoins personnels et celles du client.",
        "Passionné par l'informatique, ",
        "Stack préférée: TypeScript, React/Next.js,React Native, Laravel et Tailwind CSS.",
      ],
    },
  },
  en: {
